...
type CommentRpcService interface {
	...
	GetCommentCnt(ctx context.Context, vid int64) (r int64, err error)
}
...
func (p *CommentRpcServiceClient) GetCommentCnt(ctx context.Context, vid int64) (r int64, err error) {
	var _args CommentRpcServiceGetCommentCntArgs
	_args.Vid = vid
	var _result CommentRpcServiceGetCommentCntResult
	if err = p.Client_().Call(ctx, "GetCommentCnt", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewCommentRpcServiceProcessor(handler CommentRpcService) *CommentRpcServiceProcessor {
	...
	self.AddToProcessorMap("GetCommentCnt", &commentRpcServiceProcessorGetCommentCnt{handler: handler})
	return self
}
...
type commentRpcServiceProcessorGetCommentCnt struct {
	handler CommentRpcService
}

func (p *commentRpcServiceProcessorGetCommentCnt) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := CommentRpcServiceGetCommentCntArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetCommentCnt", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := CommentRpcServiceGetCommentCntResult{}
	var retval int64
	if retval, err2 = p.handler.GetCommentCnt(ctx, args.Vid); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetCommentCnt: "+err2.Error())
		oprot.WriteMessageBegin("GetCommentCnt", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetCommentCnt", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type CommentRpcServiceGetCommentCntArgs struct {
	Vid int64 `thrift:"vid,1" frugal:"1,default,i64" json:"vid"`
}

func NewCommentRpcServiceGetCommentCntArgs() *CommentRpcServiceGetCommentCntArgs {
	return &CommentRpcServiceGetCommentCntArgs{}
}

func (p *CommentRpcServiceGetCommentCntArgs) InitDefault() {
	*p = CommentRpcServiceGetCommentCntArgs{}
}

func (p *CommentRpcServiceGetCommentCntArgs) GetVid() (v int64) {
	return p.Vid
}
func (p *CommentRpcServiceGetCommentCntArgs) SetVid(val int64) {
	p.Vid = val
}

var fieldIDToName_CommentRpcServiceGetCommentCntArgs = map[int16]string{
	1: "vid",
}

func (p *CommentRpcServiceGetCommentCntArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommentRpcServiceGetCommentCntArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommentRpcServiceGetCommentCntArgs) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.Vid = v
...
func (p *CommentRpcServiceGetCommentCntArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetCommentCnt_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CommentRpcServiceGetCommentCntArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *CommentRpcServiceGetCommentCntArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommentRpcServiceGetCommentCntArgs(%+v)", *p)
}

func (p *CommentRpcServiceGetCommentCntArgs) DeepEqual(ano *CommentRpcServiceGetCommentCntArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *CommentRpcServiceGetCommentCntArgs) Field1DeepEqual(src int64) bool {
...
type CommentRpcServiceGetCommentCntResult struct {
	Success *int64 `thrift:"success,0,optional" frugal:"0,optional,i64" json:"success,omitempty"`
}

func NewCommentRpcServiceGetCommentCntResult() *CommentRpcServiceGetCommentCntResult {
	return &CommentRpcServiceGetCommentCntResult{}
}

func (p *CommentRpcServiceGetCommentCntResult) InitDefault() {
	*p = CommentRpcServiceGetCommentCntResult{}
}

var CommentRpcServiceGetCommentCntResult_Success_DEFAULT int64

func (p *CommentRpcServiceGetCommentCntResult) GetSuccess() (v int64) {
	if !p.IsSetSuccess() {
		return CommentRpcServiceGetCommentCntResult_Success_DEFAULT
	}
	return *p.Success
}
func (p *CommentRpcServiceGetCommentCntResult) SetSuccess(x interface{}) {
	p.Success = x.(*int64)
}

var fieldIDToName_CommentRpcServiceGetCommentCntResult = map[int16]string{
	0: "success",
}

func (p *CommentRpcServiceGetCommentCntResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CommentRpcServiceGetCommentCntResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommentRpcServiceGetCommentCntResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommentRpcServiceGetCommentCntResult) ReadField0(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.Success = &v
...
func (p *CommentRpcServiceGetCommentCntResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetCommentCnt_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *CommentRpcServiceGetCommentCntResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *CommentRpcServiceGetCommentCntResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommentRpcServiceGetCommentCntResult(%+v)", *p)
}

func (p *CommentRpcServiceGetCommentCntResult) DeepEqual(ano *CommentRpcServiceGetCommentCntResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *CommentRpcServiceGetCommentCntResult) Field0DeepEqual(src *int64) bool {
