...
var Token_Token_DEFAULT string

func (p *Token) GetToken() (v string) {
	if !p.IsSetToken() {
		return Token_Token_DEFAULT
	}
	return *p.Token
}
...
type RegisterRequest struct {
	Email    string `thrift:"email,1,required" json:"email,required" query:"username,required"`
...
type FavoriteActionRequest struct {
	...
	ActionType int32 `thrift:"action_type,2,required" json:"action_type,required" query:"action_type,required"`
}
...
type CommentActionRequest struct {
	VideoID     int64   `thrift:"video_id,1,required" json:"video_id,required" query:"video_id,required"`
	ActionType  int32   `thrift:"action_type,2,required" json:"action_type,required" query:"action_type,required"`
	CommentText *string `thrift:"comment_text,3,optional" json:"comment_text,omitempty" query:"comment_text"`
	CommentID   *int64  `thrift:"comment_id,4,optional" json:"comment_id,omitempty" query:"comment_id"`
}
...
type RelationActionRequest struct {
	ToUserID   int64 `thrift:"to_user_id,1,required" json:"to_user_id,required" query:"to_user_id,required"`
	ActionType int32 `thrift:"action_type,2,required" json:"action_type,required" query:"action_type,required"`
}
...
type MessageActionRequest struct {
	ToUserID   int64  `thrift:"to_user_id,1,required" json:"to_user_id,required" query:"to_user_id,required"`
	ActionType int32  `thrift:"action_type,2,required" json:"action_type,required" query:"action_type,required"`
	Content    string `thrift:"content,3,required" json:"content,required" query:"content,required"`
}
...
type MessageChatRequest struct {
	ToUserID   int64 `thrift:"to_user_id,1,required" json:"to_user_id,required" query:"to_user_id,required"`
	PreMsgTime int64 `thrift:"pre_msg_time,2,required" json:"pre_msg_time,required" query:"pre_msg_time,required"`
}
